module ActiveRemote
  module Persistence
    ...
    def self.create_all!(request, options = {})
      remote = self.new
    ...
    def self.update_all!(request, options = {})
      remote = self.new
    ...
    def self.delete_all!(request, options = {})
      remote = self.new
      remote.execute!(:delete_all, request)
      options.fetch(:records, true) ? remote.__send__(:records) : remote
    end

    def self.destroy_all(*records)
      options = records.extract_options!
      remote = self.new
    ...
    def self.destroy_all!(request, options = {})
      remote = self.new
      remote.execute!(:destroy_all, request)
      options.fetch(:records, true) ? remote.__send__(:records) : remote
    end

    def self.request(rpc_method, args, options = {})
